...
## Testing
- [x] **216** PHPUnit tests across all modules (**175 Feature + 41 Unit**) — verified by runtime run on 2026-08-02: 216 passed by `php artisan test` (711 assertions). No data providers — static count equals runtime count. (This is the **canonical count**; skills reference `docs/TASK.md` rather than hardcoding it. Incremented from 214 by 2 new serialization tests added in the Quick Wins Phase 6 batch.)
